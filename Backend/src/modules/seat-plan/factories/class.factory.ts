...
import type { ClassEntity, SeatAssignment } from '../entities/seat-plan.entity.js';
...
export function toClass(model: ClassModel): ClassEntity {
  return {
    ...
    assignments: (typeof model.assignments === 'string' ? JSON.parse(model.assignments) : model.assignments) as SeatAssignment[],
