...
export type FieldOutputTypes = {
  readonly public: {
    readonly AdmitCard: {
      ...
      readonly examRoutineId: CodecTypes['pg/text@1']['output'];
      readonly seatNumber: CodecTypes['pg/text@1']['output'] | null;
      readonly roomName: CodecTypes['pg/text@1']['output'] | null;
      readonly pdfKey: CodecTypes['pg/text@1']['output'] | null;
      readonly generatedBy: CodecTypes['pg/text@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
    readonly CalendarNote: {
      readonly id: CodecTypes['pg/text@1']['output'];
    ...
    readonly ClassBooking: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly classId: CodecTypes['pg/text@1']['output'];
      readonly bookedBy: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly AdmitCard: {
      ...
      readonly examRoutineId: CodecTypes['pg/text@1']['input'];
      readonly seatNumber: CodecTypes['pg/text@1']['input'] | null;
      readonly roomName: CodecTypes['pg/text@1']['input'] | null;
      readonly pdfKey: CodecTypes['pg/text@1']['input'] | null;
    ...
    readonly ClassBooking: {
      ...
      readonly bookedBy: CodecTypes['pg/text@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            readonly admitCard: {
              ...
              uniques: readonly [{ readonly columns: readonly ['studentId', 'examRoutineId'] }];
              indexes: readonly [
                {
                  readonly name: 'admitCard_studentId_idx_bf255322';
                  readonly prefix: 'admitCard_studentId_idx';
                  readonly columns: readonly ['studentId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'admitCard_examRoutineId_idx_050be0c9';
                  readonly prefix: 'admitCard_examRoutineId_idx';
                  readonly columns: readonly ['examRoutineId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                ...
                },
                {
                  ...
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'examRoutine';
                    readonly columns: readonly ['id'];
                  };
                },
              ];
            ...
            readonly classBooking: {
              ...
              indexes: readonly [
                {
                  readonly name: 'classBooking_classId_idx_0089e5e7';
                  readonly prefix: 'classBooking_classId_idx';
                  readonly columns: readonly ['classId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'classBooking_isActive_idx_77fe3ba1';
                  readonly prefix: 'classBooking_isActive_idx';
            ...
            readonly moduleSemester: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['moduleId', 'semester'] }];
              indexes: readonly [
                {
                  readonly name: 'moduleSemester_moduleId_idx_04fe188b';
                  readonly prefix: 'moduleSemester_moduleId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'moduleSemester';
                    readonly columns: readonly ['moduleId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly studentService: {
              columns: {
                ...
                readonly role: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'STUDENT_SERVICE'>;
                  };
                };
                readonly createdAt: {
                  readonly nativeType: 'timestamptz';
...
> & {
  ...
  readonly roots: {
    ...
    readonly admitCard: { readonly namespace: 'public' & NamespaceId; readonly model: 'AdmitCard' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          readonly AdmitCard: {
            ...
            readonly relations: {
              readonly examRoutine: {
                ...
                readonly on: {
                  readonly localFields: readonly ['examRoutineId'];
          ...
          readonly ClassBooking: {
            ...
            readonly relations: Record<string, never>;
            readonly storage: {
              readonly table: 'classBooking';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly classId: { readonly column: 'classId' };
                readonly bookedBy: { readonly column: 'bookedBy' };
          ...
          readonly ExamRoutine: {
            ...
            readonly relations: {
              readonly admitCards: {
                readonly to: {
                  readonly namespace: 'public' & NamespaceId;
                  readonly model: 'AdmitCard';
                };
                readonly cardinality: '1:N';
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['examRoutineId'];
                };
              };
            };
            readonly storage: {
        ...
        readonly enum: {
          readonly Role: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'STUDENT_SERVICE'; readonly value: 'STUDENT_SERVICE' },
