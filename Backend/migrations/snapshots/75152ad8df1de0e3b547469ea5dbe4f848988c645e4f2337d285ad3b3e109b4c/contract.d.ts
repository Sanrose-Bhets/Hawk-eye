...
export type StorageHash =
  StorageHashBase<'75152ad8df1de0e3b547469ea5dbe4f848988c645e4f2337d285ad3b3e109b4c'>;
export type ExecutionHash =
  ExecutionHashBase<'cc8d8726dc97364a851a0515d098e49a424d290e6820747574ff1c7baa778052'>;
        ...
        readonly entries: {
            ...
            readonly studentService: {
              columns: {
                ...
                readonly role: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'SERVICE'>;
                  };
                };
                readonly createdAt: {
                  readonly nativeType: 'timestamptz';
          ...
          readonly valueSet: {
            readonly RTERole: {
              ...
              readonly values: readonly ['ADMIN', 'RTE'];
            };
            readonly ServiceRole: {
              readonly kind: 'valueSet';
              readonly values: readonly ['ADMIN', 'SERVICE'];
            };
            readonly StudentRole: {
              readonly kind: 'valueSet';
              readonly values: readonly ['STUDENT'];
            };
          };
        };
      };
    ...
    readonly namespaces: {
      readonly public: {
        ...
        readonly enum: {
          readonly StudentRole: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [{ readonly name: 'STUDENT'; readonly value: 'STUDENT' }];
          };
          readonly ServiceRole: {
            readonly codecId: 'pg/text@1';
